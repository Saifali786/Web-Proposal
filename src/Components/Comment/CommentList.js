		...
		<Col md={12}>
			<div className='comments-section-main'>
				<Row className='comment-list-section-header'>
					<button onClick={props.closeCommentsSection} className="comment-section-close-button">X</button>
				</Row>
				<hr/>
				<br/>
				<div>
					{
						...
						<Comment comment={comment} value={comment} setComment={setComment} deleteCommentHandler={deleteComment} itemId={index}
				...
				<Row>
					...
					<Col md={3}>
						<button id="addCommentButtonId" 
						type='submit'
						className="comment-section-add-button" 
						onClick={addCommentHandler}>Add Comment</button>
					</Col>	
				</Row>
